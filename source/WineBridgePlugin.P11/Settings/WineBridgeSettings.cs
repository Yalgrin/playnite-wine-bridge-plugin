...
namespace WineBridgePlugin.Settings
{
    public static class WineBridgeSettings
    {
        ...
        public static bool ForceHighQualityIcons => WineBridgePlugin.Settings?.ForceHighQualityIcons ?? false;

        public static bool AdvancedProcessIntegration => WineBridgePlugin.Settings?.AdvancedProcessIntegration ?? false;
