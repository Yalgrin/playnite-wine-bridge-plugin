...
namespace WineBridgePlugin.Integrations.Heroic
{
    public static class HeroicClient
    {
        ...
        public static List<HeroicInstalledGame> GetInstalledGames()
        {
            ...
            foreach (var platform in Enum.GetValues<HeroicPlatform>())
            {
                GetInstalledGames(platform).ForEach(game => result.Add(game));
            }
        ...
        public static List<HeroicInstalledGame> GetInstalledGames(HeroicPlatform platform)
        {
            ...
            {
                HeroicPlatform.Gog => GetInstalledGogGames(),
                HeroicPlatform.Amazon => GetInstallAmazonGames(),
                HeroicPlatform.Epic => GetInstallEpicGames(),
                HeroicPlatform.Custom => GetInstallCustomGames(),
                _ => []
            };
        }
        ...
        private static List<HeroicInstalledGame> GetInstallAmazonGames()
        {
            ...
            var libraryGamesMap = libraryGogGames
                .Where(g => g.Product?.AppId != null)
