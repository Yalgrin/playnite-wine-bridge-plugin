...
namespace WineBridgePlugin.Patchers
{
    public static class EpicPatcher
    {
        ...
        internal static void Patch()
        {
            ...
            try
            {
                ...
                var gogType = assembly.GetType("EpicLibrary.EpicLauncher");
                var gogLibraryType = assembly.GetType("EpicLibrary.EpicLibrary");
                // var steamPlayControllerType = assembly.GetType("EpicLibrary.SteamPlayController");
                ...
                var gogIsInstalledPrefix = AccessTools.Method(typeof(EpicPatches), "IsInstalledPrefix");
                HarmonyPatcher.HarmonyInstance.Patch(isInstalledMethod,
                    prefix: new HarmonyMethod(gogIsInstalledPrefix));
                var gogInstallationPathPrefix = AccessTools.Method(typeof(EpicPatches), "InstallationPathPrefix");
                HarmonyPatcher.HarmonyInstance.Patch(installPathMethod,
                    prefix: new HarmonyMethod(gogInstallationPathPrefix));
                var gogClientPathPrefix = AccessTools.Method(typeof(EpicPatches), "ClientExecPathPrefix");
    ...
    internal static class EpicLibraryPatches
    {
        ...
        private static bool GetInstalledGamesPrefix(ref Dictionary<string, GameMetadata> __result)
        {
            ...
            __result = HeroicGamesService.GetInstalledGames(HeroicPlatform.Epic);
            return false;
        }
    }
}