...
namespace WineBridgePlugin
{
    public static class Constants
    {
        ...
        public const string DummyItchIoExe = "DUMMY-ITCH-IO-PATH.exe";
        public const string DummyItchButlerExe = "DUMMY-ITCH-BUTLER-PATH.exe";
        ...
        public const string ItchPrefix = "itch://";
